...
/**
 * Mode4BaseF2MD is a new application developed to be used with Mode 4 based simulation
...
void Mode4BaseF2MD::initialize(int stage)
{
...
void Mode4BaseF2MD::handleMessage(cMessage* msg)
{
...
void Mode4BaseF2MD::handleLowerMessage(cMessage* msg){
}

void Mode4BaseF2MD::handleSelfMessage(cMessage* msg){
}

void Mode4BaseF2MD::sendLowerPackets(cPacket* pkt)
{
    send(pkt, lowerGateOut_);
}

void Mode4BaseF2MD::finish()
{
}

Mode4BaseF2MD::~Mode4BaseF2MD()
{
}
